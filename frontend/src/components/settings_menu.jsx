  ...
  render() {
    return(
      <div className="settings_menu" ref={node => this.node = node}>
        ...
        <div className="settings_menu_choose_topic">
          <label className="settings_menu_label">Choose topic 2</label>
          <TopicSelect handleChange={t => this.handleChangeTopic(t, 1)} value={this.props.chosenTopics[1]} topics={this.props.topics} id="settings_menu_choose_topic_select_2"/>
        </div>
